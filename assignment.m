function [] = assignment()
% ASSIGNMENT Part A and B of the assignment - Implementing a wall-following 
% algorithm that uses PD error control to avoid obstacles, and which recognises
% intruders in the pitch by processing images from the camera node
